                ...
                <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg p-8 mb-8">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            { n: 4, t: 'Prototipado', d: 'Prototipos HTML con Tailwind CDN (uno por pantalla del flujo)' },
                            { n: 5, t: 'Handoff', d: 'ZIP con HTML, documentación y entregables para desarrollo' },
                        ].map((row) => (
